...
public interface PostgreSQLBlocksDao extends BlocksDao {
	String QUERY_UPDATE = "INSERT INTO <prefix>blocks (\"player\", \"material_name\", \"destroyed\")" +
			" VALUES (?, ?, ?)" +
			" ON CONFLICT (\"player\", \"material_name\") DO UPDATE SET destroyed = <prefix>blocks.destroyed + EXCLUDED.destroyed";
	String QUERY_SET = "INSERT INTO <prefix>blocks (\"player\", \"material_name\", \"destroyed\")" +
			" VALUES (?, ?, ?)" +
			" ON CONFLICT (\"player\", \"material_name\") DO UPDATE SET destroyed=EXCLUDED.destroyed";
